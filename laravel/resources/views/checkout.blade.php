...
<body class="min-h-screen bg-bg text-text">
    ...
    <main
        x-data="{ delivery: '{{ old('delivery', 'courier') }}' }"
        class="mx-auto max-w-7xl px-4 py-6 tablet:px-6 tablet:py-10"
    >
        <a
            href="{{ route('cart.index') }}"
            class="block pb-4 text-placeholder transition hover:text-accent"
            >← Back to Cart</a
        >

        <div
            class="mb-6 flex flex-col gap-3 tablet:flex-row tablet:items-start tablet:justify-between"
        >
        ...
        <div
            class="grid grid-cols-1 gap-6 desktop:grid-cols-[1fr_380px] desktop:gap-8"
        >
            {{-- Checkout Form --}}
            <section
            ...
            >
                @if (session('error'))
                    <div
                        class="mb-5 rounded-xl border border-red-500 bg-red-500/10 px-4 py-3 text-sm text-red-400"
                    >
                        {{ session('error') }}
                    </div>
                @endif
                ...
                >
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 gap-4 tablet:grid-cols-2">
                            <div>
                                <label
                                    for="firstName"
                                    class="mb-1 block text-xs font-semibold text-placeholder"
                                    >First Name</label
                                >
                    ...
                    {{-- Delivery --}}
                    <div
                        class="mb-6 rounded-2xl border border-border bg-bg p-4"
                    >
                        <h3 class="text-sm font-semibold">
                            Delivery Method (Souvenirs)
                        </h3>
                        <p class="mt-1 text-xs text-placeholder">Choose how you'd like your souvenir order delivered.</p>

                        <div
                            class="mt-4 grid grid-cols-1 gap-3 tablet:grid-cols-3"
                        >
                            <label
                            ...
                            >
                                ...
                                <span class="min-w-0">
                                    <span class="block text-sm font-semibold"
                                        >Courier</span
                                    >
                                    <span class="block text-xs text-placeholder"
                                        >Delivery to your address.</span
                                    >
                                </span>
                            </label>
                            ...
                            >
                                ...
                                <span class="min-w-0">
                                    ...
                                    >
                                    <span class="block text-xs text-placeholder"
                                        >Pickup from a nearby locker.</span
                                    >
                                </span>
                            </label>
                        ...
                        <div class="grid grid-cols-1 gap-4 tablet:grid-cols-2">
                            ...
                            <div class="tablet:col-span-2">
                                ...
                                >
                                    ...
                                    <option
                                        @selected (old('country') === 'Germany')
                                        >Germany
                                    </option>
                                    <option
                                        @selected (old('country') === 'France')
                                        >France
                                    </option>
                                    <option
                                        @selected (old('country') === 'Spain')
                                        >Spain
                                    </option>
                                    <option
                    ...
                    <div>
                        ...
                        <div class="rounded-2xl border border-border bg-bg p-4">
                            ...
                            >
                                ...
                                <label
                                    class="flex items-center gap-2 text-sm text-placeholder"
                                >
                                    <input
                                        type="radio"
                                        name="payment"
                            ...
                            <div
                                class="mt-4 grid grid-cols-1 gap-4 tablet:grid-cols-2"
                            >
                                <div class="tablet:col-span-2">
                                    <label
                                        for="cardNumber"
            ...
            {{-- Order Summary --}}
            <aside
                class="self-start rounded-2xl border border-border bg-dark p-5 shadow-[0_14px_36px_rgba(0,0,0,.4)] tablet:p-6 desktop:sticky desktop:top-6"
            >
                        ...
                        <div>
                            ...
                            <div class="flex flex-col gap-3">
                                @foreach ($tickets as $item)
                                    <div
                                        class="flex items-center gap-3 rounded-xl border border-border bg-bg p-3"
                                    >
                                        <a
                                            href="{{ $item['url'] }}"
                                            class="shrink-0 w-14 overflow-hidden rounded-lg"
                                        >
                                            <img
                                                src="{{ $item['image'] }}"
                                                alt="{{ $item['name'] }}"
                                        ...
                                        <div
                                            class="flex-shrink-0 text-sm font-bold text-accent"
                                        >
