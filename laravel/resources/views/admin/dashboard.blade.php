          ...
          <table class="w-full text-sm">
            ...
            <tbody>
              <tr class="border-b border-border transition hover:bg-button/40">
                ...
                <td class="px-5 py-3 hidden desktop:table-cell max-w-xs truncate text-placeholder">An action-packed adventure for the whole family.</td>
                <td class="px-5 py-3 text-right">
                  <div class="flex items-center justify-end gap-2">
                    <a href="#" class="rounded-lg border border-border bg-button px-3 py-1.5 text-xs transition hover:border-accent hover:text-accent">Edit</a>
                    <button class="rounded-lg border border-border bg-button px-3 py-1.5 text-xs transition hover:border-red-500 hover:text-red-500">Delete</button>
                  </div>
                </td>
              </tr>
