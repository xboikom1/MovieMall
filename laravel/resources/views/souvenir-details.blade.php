...
<body class="min-h-screen bg-bg text-text">
    ...
    <main class="mx-auto max-w-7xl px-4 py-6 tablet:px-6 tablet:py-10">
        ...
        <section class="grid grid-cols-1 gap-8 tablet:grid-cols-2">
            ...
            >
                <div
                    class="aspect-square overflow-hidden rounded-2xl bg-button w-full relative"
                >
            ...
            <div class="flex flex-col gap-6">
                ...
                <div
                    class="rounded-2xl border border-border bg-dark p-5 shadow-[0_14px_36px_rgba(0,0,0,.40)] tablet:p-6"
                >
                    <h2 class="text-xl font-bold tablet:text-2xl">
                        Description
                    </h2>
                    ...
                    <div class="mt-6 border-t border-border pt-6">
                        ...
                        >
                            ...
                            <div
                                class="flex flex-col gap-3 tablet:flex-row tablet:items-center tablet:justify-between"
                            >
                                <div>
                                    <p class="mb-2 text-xs font-semibold uppercase tracking-widest text-placeholder">Quantity</p>
                                    <div
                                        class="inline-flex h-10 items-center overflow-hidden rounded-xl border border-border bg-bg"
                                    >
                                        <label
                                            for="quantityInput"
                                            class="sr-only"
                        ...
                        <div
                            class="mt-5 rounded-xl border border-border bg-bg p-4"
                        >
                            <div class="text-sm">
        ...
        <section class="mt-12">
            ...
            <ul
                class="grid grid-cols-2 gap-4 tablet:grid-cols-3 tablet:gap-5 desktop:grid-cols-5"
            >
                @foreach (array_slice($souvenir['related_souvenirs'], 0, 5) as $s)
                    ...
                    >
                        <a
                            href="{{ route('souvenirs.show', \Illuminate\Support\Str::slug($s['title'])) }}"
