...
<body class="min-h-screen bg-bg text-text">
    <header
        class="border-b border-border bg-dark shadow-[0_14px_36px_rgba(0,0,0,0.4)]"
    >
        <div
        ...
        >
            <div class="flex items-center gap-3 tablet:gap-6">
                <a
                    href="{{ route('home') }}"
                    class="flex items-center rounded-xl bg-accent px-4 py-2 font-semibold tablet:text-lg"
                >
                    MovieMall
                </a>
                <nav class="hidden gap-2 text-sm tablet:flex">
                    <a
                        ...
                        class="rounded-lg border border-border bg-button px-4 py-2 transition hover:bg-accent"
                    >
                        Movies
                    </a>
                    <a
            ...
            <div
                class="flex items-center gap-2 text-xs tablet:gap-4 tablet:text-sm"
            >
                <span class="hidden text-placeholder tablet:block"
    ...
    <main
        class="mx-auto flex min-h-[calc(100vh-76px)] max-w-7xl items-center justify-center px-4 py-8 tablet:px-6 tablet:py-14"
    >
        <section
        ...
        >
            <h1 class="mb-6 text-2xl font-bold tablet:mb-8 tablet:text-4xl">
                Create your account
            </h1>
            ...
            <form
                ...
                class="mx-auto flex max-w-xl flex-col gap-4 tablet:gap-6"
            >
                @csrf

                <div class="grid grid-cols-1 gap-4 tablet:grid-cols-2">
                    <div>
                        <label class="sr-only" for="register-first-name"
                            >First Name</label
                        >
                        <input
                    ...
                    <div>
                        <label class="sr-only" for="register-last-name"
                            >Last Name</label
                        >
                        <input
